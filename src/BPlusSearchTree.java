...
public class BPlusSearchTree {
	 ...
	 */
	public List<String> search(int key1, int key2){
		// traverse to the leaf node
		TreeNode currNode = this.root;
		while(currNode.children.size() != 0) 
	 ...
	 */
	public void splitInternalNode(TreeNode currNode, TreeNode childNode, TreeNode newNode, boolean updatePointers) {
		if(currNode == null) {
			// create new root
			this.root = newNode;
